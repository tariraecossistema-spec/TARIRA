          ...
          {submittedProposal ? (
            ...
            <div className="space-y-6 text-center py-4">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
                ...
                <a
                  href={`https://wa.me/258840000000?text=${encodeURIComponent(`Olá TARIRA Comercial! Acabei de submeter a requisição B2B #${submittedProposal.id} para a empresa ${submittedProposal.companyName}. Gostaria de falar com o gestor comercial.`)}`}
                  target="_blank"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-background-secondary border border-border rounded-xl p-3 flex flex-wrap items-center justify-between gap-3 text-xs">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  >
                    <Phone className="w-3.5 h-3.5 text-status-success" /> +258 84 000 0000
                  </a>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      placeholder="Ex: Vodacom Moçambique, SA"
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Ex: Diretora de RH / Procurement"
                      value={formData.role}
                  ...
                  <div>
                    ...
                    <input
                      type="email"
                      required
                      placeholder="sara.machava@empresa.co.mz"
